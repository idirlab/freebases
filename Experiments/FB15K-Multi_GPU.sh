...
###FB15K-DistMult:
CUDA_VISIBLE_DEVICES=0,1 nohup dglke_train --model_name DistMult --dataset FB15k --batch_size 1000 --log_interval 1000 \
...
###FB15K-ComplEx:
CUDA_VISIBLE_DEVICES=0,1 nohup dglke_train --model_name ComplEx --dataset FB15k --batch_size 1000 --log_interval 1000 \
...
###FB15K-TransR:
CUDA_VISIBLE_DEVICES=0,1 nohup dglke_train --model_name TransR --dataset FB15k --batch_size 1000 --log_interval 1000 \
...
###FB15K-RotatE:
CUDA_VISIBLE_DEVICES=0,1 nohup dglke_train --model_name RotatE --dataset FB15k --batch_size 1024 --log_interval 1000 --neg_sample_size 256 \
